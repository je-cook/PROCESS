...
class CCFE_HCPB:
    ...
    @staticmethod
    @njit(cache=True)
    def st_cp_angle_fraction(h_cp_top, r_cp_mid, r_cp_top, rmajor):
    ...
    @staticmethod
    @njit(cache=True)
    def st_tf_centrepost_fast_neut_flux(pneutmw, sh_width, rmajor, i_tf_sup):
        """Author S Kahn
        ...
        :param rmajor: Plasma major radius [m]
        :param i_tf_sup: tf support type
    ...
    @staticmethod
    @njit(cache=True)
    def st_centrepost_nuclear_heating(pneut, sh_width, rmajor, i_tf_sup):
        ...
        # Copper TF centrepost
            ...
            shw_rmjr = sh_width_eff * sh_width / rmajor
            ...
            pneut_800 = pneut / 800
            pnuc_cp_wp_gam = pneut_800 * pnuc_cp_wp_gam
            pnuc_cp_wp_n = pneut_800 * pnuc_cp_wp_n
            pnuc_cp_case_gam = pneut_800 * pnuc_cp_case_gam
            pnuc_cp_case_n = pneut_800 * pnuc_cp_case_n
            pnuc_cp_sh_gam = pneut_800 * pnuc_cp_sh_gam
            pnuc_cp_sh_n = pneut_800 * pnuc_cp_sh_n
